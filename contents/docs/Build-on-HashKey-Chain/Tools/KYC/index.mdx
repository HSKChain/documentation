...
This guide provides detailed information about integrating with the HSKChain KYC (Know Your Customer) system. The KYC system is implemented as a Soul Bound Token (SBT) on the HSKChain, providing on-chain verification of user identity.

## Overview

The HSKChain KYC system provides:
...
For technical support or questions about the KYC integration, please contact the HSKChain support team or visit our [developer portal](https://kyc-testnet.hunyuankyc.com/).
